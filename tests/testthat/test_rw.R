...
test_that("write_pq function works fine with enterotype dataset", {
  ...
  expect_silent(write_pq(enterotype, path = testFolder, silent = TRUE, sam_data_first = TRUE, one_file = TRUE))
  expect_silent(write_pq(enterotype, path = testFolder, silent = TRUE, write_sam_data = FALSE, one_file = TRUE))
...
test_that("write_pq function works fine with data_fungi dataset", {
  ...
  expect_silent(write_pq(data_fungi, path = testFolder, silent = TRUE, sam_data_first = TRUE, one_file = TRUE))
