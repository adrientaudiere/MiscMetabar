...
#> [1] "vsearch  --sintax temp.fasta --db /tmp/RtmpDT6YFj/temp_libpath3a2523ffa80ed/MiscMetabar/extdata/mini_UNITE_fungi.fasta.gz --tabbedout output_taxo_vs.txt  --threads 1 --sintax_random"
