...
#> [1] "vsearch  --sintax '/tmp/RtmplwIHEj/temp.fasta' --db '/tmp/RtmpRD3W8T/temp_libpath3b704e3755e/MiscMetabar/extdata/mini_UNITE_fungi.fasta.gz' --tabbedout '/tmp/RtmplwIHEj/output_taxo_vs.txt' --threads 1 --sintax_random"
