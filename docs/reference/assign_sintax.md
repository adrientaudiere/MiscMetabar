...
#> [1] "vsearch  --sintax '/tmp/RtmpMeUGPY/temp.fasta' --db '/tmp/RtmpLIkWpu/temp_libpath910a4224b8c62/MiscMetabar/extdata/mini_UNITE_fungi.fasta.gz' --tabbedout '/tmp/RtmpMeUGPY/output_taxo_vs.txt' --threads 1 --sintax_random"
