...
#> number of iterations= 13 
#> number of iterations= 4 
#> The filtering processes discard 65 taxa and 36502 sequences. Note that for  65 samples, all taxa were discarded. Please run clean_pq() to remove empty samples.
