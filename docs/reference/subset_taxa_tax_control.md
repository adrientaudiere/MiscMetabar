...
#> number of iterations= 16 
#> number of iterations= 7 
#> The filtering processes discard 66 taxa and 37044 sequences. Note that for  66 samples, all taxa were discarded. Please run clean_pq() to remove empty samples.
