...
#>   [1] DBI_1.3.0                   Rdpack_2.6.6               
#>   [3] bitops_1.0-9                pbapply_1.7-4              
#>   [5] deldir_2.0-4                permute_0.9-10             
#>   [7] rlang_1.2.0                 magrittr_2.0.5             
#>   [9] ade4_1.7-24                 otel_0.2.0                 
#>  [11] matrixStats_1.5.0           compiler_4.5.2             
#>  [13] mgcv_1.9-4                  png_0.1-9                  
#>  [15] systemfonts_1.3.2           vctrs_0.7.3                
#>  [17] reshape2_1.4.5              stringr_1.6.0              
#>  [19] pwalign_1.6.0               pkgconfig_2.0.3            
#>  [21] crayon_1.5.3                fastmap_1.2.0              
#>  [23] XVector_0.50.0              labeling_0.4.3             
#>  [25] Rsamtools_2.26.0            rmarkdown_2.31             
#>  [27] ragg_1.5.2                  xfun_0.57                  
#>  [29] cachem_1.1.0                cigarillo_1.0.0            
#>  [31] jsonlite_2.0.0              biomformat_1.38.3          
#>  [33] rhdf5filters_1.22.0         DelayedArray_0.36.1        
#>  [35] Rhdf5lib_1.32.0             BiocParallel_1.44.0        
#>  [37] jpeg_0.1-11                 parallel_4.5.2             
#>  [39] cluster_2.1.8.2             R6_2.6.1                   
...
#>  [69] desc_1.4.3                  survival_3.8-6             
#>  [71] RcppParallel_5.1.11-2       Biostrings_2.78.0          
...
#>  [81] tools_4.5.2                 interp_1.1-6               
#>  [83] data.table_1.18.2.1         GenomicAlignments_1.46.0   
#>  [85] fs_2.0.1                    rhdf5_2.54.1               
