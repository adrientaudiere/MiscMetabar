# Plot information about Guild from tax_table slot previously created with [`add_funguild_info()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/add_funguild_info.md)
