...
#> number of iterations= 18 
#> number of iterations= 9 
#> The filtering processes discard 67 taxa and 36587 sequences. Note that for  67 samples, all taxa were discarded. Please run clean_pq() to remove empty samples.
