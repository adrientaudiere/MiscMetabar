...
#> number of iterations= 14 
#> number of iterations= 7 
#> The filtering processes discard 59 taxa and 35635 sequences. Note that for  59 samples, all taxa were discarded. Please run clean_pq() to remove empty samples.
#> phyloseq-class experiment-level object
#> otu_table()   OTU Table:         [ 1361 taxa and 185 samples ]
#> sample_data() Sample Data:       [ 185 samples by 7 sample variables ]
#> tax_table()   Taxonomy Table:    [ 1361 taxa by 12 taxonomic ranks ]
#> refseq()      DNAStringSet:      [ 1361 reference sequences ]
```
