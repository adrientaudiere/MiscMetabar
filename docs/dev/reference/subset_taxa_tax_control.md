...
#> number of iterations= 13 
#> number of iterations= 5 
#> The filtering processes discard 58 taxa and 35633 sequences. Note that for  58 samples, all taxa were discarded. Please run clean_pq() to remove empty samples.
#> phyloseq-class experiment-level object
#> otu_table()   OTU Table:         [ 1362 taxa and 185 samples ]
#> sample_data() Sample Data:       [ 185 samples by 7 sample variables ]
#> tax_table()   Taxonomy Table:    [ 1362 taxa by 12 taxonomic ranks ]
#> refseq()      DNAStringSet:      [ 1362 reference sequences ]
```
