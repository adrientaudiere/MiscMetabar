...
### See also vignette on [exploring data](https://adrientaudiere.github.io/MiscMetabar/dev/reference/articles/explore_data.md)
...
- [`assign_mmseqs2()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/assign_mmseqs2.md)
...
### Transform OTU table only. See also vignette on [transformation & normalisation](https://adrientaudiere.github.io/MiscMetabar/dev/reference/articles/normalization.md)
...
- [`select_taxa()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/select_taxa-methods.md)
...
- [`subset_samples_pq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/subset_samples_pq.md)
...
- [`lulu_pq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/lulu_pq.md)
  :

  Lulu reclustering of class `physeq`

- [`mmseqs2_clustering()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/mmseqs2_clustering.md)
...
- [`add_dna_to_phyloseq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/add_dna_to_phyloseq.md)
  :
...
- [`hill_test_rarperm_pq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/hill_test_rarperm_pq.md)
  **\[obsolète\]** : Test multiple times effect of factor on Hill
...
- [`adonis_rarperm_pq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/adonis_rarperm_pq.md)
  **\[obsolète\]** : Permanova (adonis) on permutations of rarefaction
  even depth
...
- [`var_par_rarperm_pq()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/var_par_rarperm_pq.md)
  **\[obsolète\]** : Partition the Variation of a phyloseq object with
...
- [`phyloseq_to_edgeR()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/phyloseq_to_edgeR.md)
...
- [`vs_search_global()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/vs_search_global.md)
  :
...
- [`rename_samples_otu_table()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/rename_samples_otu_table.md)
...
- [`data_fungi`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/data_fungi.md)
  : Fungal OTU in phyloseq format

- [`data_fungi_mini`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/data_fungi_mini.md)
  : Fungal OTU in phyloseq format

- [`data_fungi_sp_known`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/data_fungi_sp_known.md)
  : Fungal OTU in phyloseq format

- [`Tengeler2020_pq`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/Tengeler2020_pq.md)
  :
...
- [`funky_color()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/funky_color.md)
  : Funky palette color
...
- [`format2dada2_species()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/format2dada2_species.md)
...
- [`find_mmseqs2()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/find_mmseqs2.md)
...
- [`install_mmseqs2()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/install_mmseqs2.md)
...
- [`is_mmseqs2_installed()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/is_mmseqs2_installed.md)
...
- [`is_krona_installed()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/is_krona_installed.md)
...
- [`is_mumu_installed()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/is_mumu_installed.md)
...
- [`multiplot()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/multiplot.md)
...
- [`diff_fct_diff_class()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/diff_fct_diff_class.md)
  : Compute different functions for different class of vector.
- [`perc()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/perc.md)
  : Convert a value (or a fraction x/y) in percentage
- [`unique_or_na()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/unique_or_na.md)
  : Get the unique value in x or NA if none

### Others

- [`all_object_size()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/all_object_size.md)
...
- [`dist_bycol()`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/dist_bycol.md)
...
- [`MiscMetabar-package`](https://adrientaudiere.github.io/MiscMetabar/dev/reference/MiscMetabar-package.md)
  :
