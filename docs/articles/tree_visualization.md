...
#>  [5] MiscMetabar_0.14.6 purrr_1.2.1        dplyr_1.2.0        dada2_1.38.0      
#>  [9] Rcpp_1.1.1         ggplot2_4.0.2      phyloseq_1.54.0    tidytree_0.4.7    
#> 
...
#>  [71] survival_3.8-6              RcppParallel_5.1.11-1      
...
#>  [83] gdtools_0.5.0               lazyeval_0.2.2             
#>  [85] tools_4.5.2                 interp_1.1-6               
#>  [87] data.table_1.18.2.1         GenomicAlignments_1.46.0   
#>  [89] ggiraph_0.9.4               fs_1.6.6                   
#>  [91] fastmatch_1.1-8             rhdf5_2.54.1               
#>  [93] grid_4.5.2                  tidyr_1.3.2                
#>  [95] latticeExtra_0.6-31         patchwork_1.3.2            
#>  [97] nlme_3.1-168                cli_3.6.5                  
#>  [99] rappdirs_0.3.4              textshaping_1.0.4          
#> [101] fontBitstreamVera_0.1.1     S4Arrays_1.10.1            
#> [103] gtable_0.3.6                yulab.utils_0.2.4          
