...
- Indicate default values only when (i) a set of values is possible [e.g bray method in vegdist] or (ii) when this value 
is well thought out and a good default value for most users [e.g. the number of permutation or processors, or the level of identity to cluster at 97%]. 
