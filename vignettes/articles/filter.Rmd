...
### Randomly subset taxa

For testing, creating example datasets, or computational efficiency, you may want to randomly subset a specified number of taxa. The [subset_taxa_random()] function provides a succinct way to do this:

```{r}
# Randomly select 20 taxa (most succinct way)
data_fungi_20 <- subset_taxa_random(data_fungi, 20)

# With a seed for reproducibility
data_fungi_20_repro <- subset_taxa_random(data_fungi, 20, seed = 123)
```
