...
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](https://github.com/adrientaudiere/MiscMetabar/blob/main/CODE_OF_CONDUCT.md) 
...
Most of the development work on this package has been done on a voluntary basis without payment. If you appreciate this work, please feel free to use it, cite it in your projects, let me know about any bugs you find, and contribute improvements via pull requests. Community engagement and collaboration are what make open-source projects thrive. Please use github issues if you need help. As a freelancer, I am available to work on projects related to this R package.


### Note for non-Linux users

Some functions may not work on Windows (*e.g.* `track_wkflow()`, `cutadapt_remove_primers()`, `krona()`, `vsearch_clustering()`, ...). A solution is to exploit docker container, for example using the great [rocker project](https://rocker-project.org/).
