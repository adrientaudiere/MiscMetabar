...
if (getRversion() >= "2.15.1") {
  utils::globalVariables(c(".id", "%>%", "Ab", "Abundance", "ASV_names", "beta.div", "calc_taxon_abund", 
"character_method", "Class", "col_tax", "colors", "combn", "complement", 
"devtools", "e-value", "Family", "Genus", "grid.draw", "grid.layout", 
...
"ott_id", "OTU", "p.adj", "p.adjust", "parse_phyloseq", "plot_layout", 
